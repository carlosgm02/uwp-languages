...
declare module WinJS {
    ...
    module Application {
        ...
        let local: IOHelper;
        let roaming: IOHelper;
        let onactivated: EventListener;
        ...
        let oncheckpoint: EventListener;
        function start(): void;
        function stop(): void;
    }
    class Promise<T> {
    ...
    module Navigation {
        ...
        let onbeforenavigate: CustomEvent;
        let onnavigated: CustomEvent;
        let onnavigating: CustomEvent;
    }
    module Utilities {
